...
public class DeleteItemByPatchProcessor implements RequestProcessor {
    private ItemsRepository itemsRepository;

    public DeleteItemByPatchProcessor(ItemsRepository itemsRepository) {
        this.itemsRepository = itemsRepository;
    }

    @Override
    public void execute(HttpRequest request, OutputStream output) throws IOException, SQLException {
        Long id = Long.parseLong(request.getPathVariable("id"));
